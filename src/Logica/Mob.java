...
public class Mob extends Rectangle {
	...
	public int xC, yC;
	public int health;
	public int healthSpace = 2, healthHeight = 6;	 
	...
	public int walkFrame = 0, walkSpeed = 23;
	...
	public void physic() {
		if(walkFrame >= walkSpeed) {
			...
			if(mobWalk == Screen.room.blockSize) {
				...
				if(Screen.room.block[yC][xC].airID == Value.airTree) {
					deleteMob();
					loseHealth();
				}
	...
	public void loseHealthEnemy(int amount) {
		health -= amount;
